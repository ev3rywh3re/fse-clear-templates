...
/**
 * Deletes all existing Full Site Editor templates and template parts.
 *
...
function delete_fse_templates() {
    ...
    // Delete all posts of type 'wp_template'.
    $wpdb->delete( $wpdb->posts, [ 'post_type' => 'wp_template' ], [ '%s' ] );
    // Delete all posts of type 'wp_template_part'.
    $wpdb->delete( $wpdb->posts, [ 'post_type' => 'wp_template_part' ], [ '%s' ] );
}
